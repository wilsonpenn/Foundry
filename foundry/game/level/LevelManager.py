...
class LevelManager:
    ...
    def on_enable(self):
        ...
        create_toolbar(self.parent, "Level MutableSize", [self.parent.level_size_bar], Qt.RightToolBarArea)
        create_toolbar(self.parent, "Enemy MutableSize", [self.parent.enemy_size_bar], Qt.RightToolBarArea)
